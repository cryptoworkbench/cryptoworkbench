#include <stdio.h>
#include <stdlib.h>
#include "../../libraries/functional/string.basic.h" // contains: function 'str_represents_u()', definition 'EXIT_STATUS_GOODBYE'
#include "../../libraries/mathematics/maths.basic.h" // contains: function 'sieve_of_eratosthenes()', 'primes_printed_from_sieve_array_to_FS()', TYPE definition (typedef) 'ul', definition 'ADDITIVE_IDENTITY', 'extern ul mod'
