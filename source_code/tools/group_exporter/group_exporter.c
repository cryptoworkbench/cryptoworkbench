...
int main(int argc, char **argv) {
    ...
    char *BUFFER = BUFFER_OF_SIZE(400); sprintf(BUFFER, "Exporting <\u2124/%lu\u2124, %s> (the %s group of integers modulus %lu)", group.CAP, operation_symbol_to_use(group.ID), adjective_to_use(group.ID), group.CAP);
