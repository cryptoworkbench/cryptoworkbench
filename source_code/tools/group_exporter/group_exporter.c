...
int main(int argc, char **argv) {
    ...
    char *BUFFER = BUFFER_OF_SIZE(400); sprintf(BUFFER, "Exporting <\u2124/%lu\u2124, %s> (the %s group of integers modulus %lu)", group.CAP, combination_SYMBOL_for_(group.ID), ADJECTIVE_TO_USE(group.ID), group.CAP);
