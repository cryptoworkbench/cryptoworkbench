...
else echo "                      '2_n_Shamir_Secret_Sharing' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      '3_n_Shamir_Secret_Sharing' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'additive_inverse' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'dh_key_agreement' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'divide' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'equivalence_class' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'factorization_based_primality_test' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'factorize' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'greatest_common_divisor' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'group_element_exporter' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'group_operation' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'jacobi_symbol' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'least_common_multiple' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'modular_exponentiation' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'multiplicative_inverse' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'plot_polynomial' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'prime_factorize' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'prime_table_exporter' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'quadratic_residue' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'random_numbers' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'sieve_of_eratosthenes' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'subgroup_examplifier' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'system_of_congruences' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'View_LOGBOOK' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'Wipe_ARCHIVE' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
...
else echo "                      'Wipe_LOGBOOK' FAILED TO COMPILE!"; failed_builds=$(( $failed_builds + 1 )); fi; cd ../
