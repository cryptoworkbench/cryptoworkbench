...
int main(int argc, char **argv) { unsigned long mod; mod_ = &mod;
    conditional_goodbye(n(n(error_specification(mod_parsing_error, n(str_represents_ul_(argv[1], mod_, -1)))))); unsigned long inverse_of_additve_inverse;
    conditional_goodbye(n(n(error_specification(id_parsing_error, n(str_represents_ul_(argv[2], &inverse_of_additve_inverse, -2)))))); unsigned long additive_inverse = mod_inverse(inverse_of_additve_inverse);
