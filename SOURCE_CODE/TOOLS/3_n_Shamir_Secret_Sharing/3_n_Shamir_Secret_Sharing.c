...
int main(int argc, char **argv) {
    ...
    *coefficient[2] = subtract(*equation[0][0], add(multiply(*coefficient[1], *equation[0][1]), (multiply(*coefficient[0], exponentiate(*equation[0][1], 2, MOD_REPORT())))));
    ...
    fprintf(stdout, "f(x) \u2261 %lu * x^2 + %lu * x + %lu	(modulus %lu)\n", *coefficient[0], *coefficient[1], *coefficient[2], MOD_REPORT());
