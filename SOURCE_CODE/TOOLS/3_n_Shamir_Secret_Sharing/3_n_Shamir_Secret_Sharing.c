...
int main(int argc, char **argv) {
    ...
    fprintf(stdout, "\nf(z): "); fscanf(stdin, "%lu", &point_three.y); fprintf(stdout, "z   : "); fscanf(stdin, "%lu", &point_three.x);
    ...
    fprintf(stdout, "\nInferred from points one, two, and three, that the second-degree polynomial that generated the above table must have had 'a = %lu', 'b = %lu' and 'c = %lu' a.k.a. ", a, b, c);
