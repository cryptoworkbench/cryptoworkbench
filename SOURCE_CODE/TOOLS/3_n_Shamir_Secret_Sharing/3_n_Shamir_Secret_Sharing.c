...
int main(int argc, char **argv) {
    ...
    *equation[0][2] = _exponentiate(*equation[0][1], 2, mod_); *equation[1][2] = _exponentiate(*equation[1][1], 2, mod_); *equation[2][2] = _exponentiate(*equation[2][1], 2, mod_);
    ...
    *coefficient[2] = mod_subtract(*equation[0][0], mod_add(mod_multiply(*coefficient[1], *equation[0][1]), (mod_multiply(*coefficient[0], _exponentiate(*equation[0][1], 2, mod_)))));
    ...
    fprintf(stdout, "f(x) \u2261 %lu * x^2 + %lu * x + %lu	(modulus %lu)\n", *coefficient[0], *coefficient[1], *coefficient[2], mod_);
