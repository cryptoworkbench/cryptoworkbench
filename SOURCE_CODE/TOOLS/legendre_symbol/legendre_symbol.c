// legendre_symbol() seems to calculate Legendre's symbol using Euler's criterion. Good.
// I need to make a wrapper function which factorizes 'p' in order to be able to use legendre_symbol() as a backhand
// and calculate any:
// ( __composite__ / P )
//
// LEGENDRE SYMBOL.
