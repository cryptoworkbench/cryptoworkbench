...
unsigned long mod; int main(int argc, char **argv) { mod_ = &mod;
    conditional_goodbye(n(n(error_specification_message(mod_error, n(str_represents_ul_(argv[1], &mod, -1)))))); unsigned long numerator;
    conditional_goodbye(n(n(error_specification_message(numerator_error, n(str_represents_ul_(argv[2], &numerator, -2)))))); unsigned long denominator;
    conditional_goodbye(n(n(error_specification_message(denominator_error, n(str_represents_ul_(argv[3], &denominator, -3))))));
