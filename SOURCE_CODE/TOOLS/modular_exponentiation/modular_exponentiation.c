...
int main(int argc, char **argv) { unsigned long mod;
    mod_ = &mod;            conditional_goodbye(n(n(error_specification(mod_error, str_represents_ul_(argv[1], mod_, -1)))));
    unsigned long base;     conditional_goodbye(n(n(error_specification(base_error, str_represents_ul_(argv[2], &base, -1)))));
    unsigned long exponent; conditional_goodbye(n(n(error_specification(exponent_error, str_represents_ul_(argv[3], &exponent, -1)))));
