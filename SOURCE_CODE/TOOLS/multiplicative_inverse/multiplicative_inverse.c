...
int main(int argc, char **argv) { argv_location = &argv; 
    unsigned long multiplicative_group_modulus;      conditional_goodbye(n(n(error_specification(mod_error, n(str_represents_ul_(argv[1], &multiplicative_group_modulus, -1)))))); mod_ = &multiplicative_group_modulus;
    unsigned long element_from_multiplicative_group; conditional_goodbye(n(n(error_specification(multiplicative_group_element_error, n(str_represents_ul_(argv[2], &element_from_multiplicative_group, -2))))));
