...
cd 2_n_Shamir_Secret_Sharing && make 2_n_Shamir_Secret_Sharing > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd 3_n_Shamir_Secret_Sharing && make 3_n_Shamir_Secret_Sharing > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd additive_inverse && make additive_inverse > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd dh_key_agreement && make dh_key_agreement > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd divide && make divide > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd equivalence_class && make equivalence_class > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd factorization_based_primality_test && make factorization_based_primality_test > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd factorize && make factorize > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd greatest_common_divisor && make greatest_common_divisor > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd group_element_exporter && make group_element_exporter > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd group_operation && make group_operation > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd jacobi_symbol && make jacobi_symbol > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd least_common_multiple && make least_common_multiple > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd modular_exponentiation && make modular_exponentiation > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd multiplicative_inverse && make multiplicative_inverse > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd plot_polynomial && make plot_polynomial > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd prime_factorize && make prime_factorize > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd prime_table_exporter && make prime_table_exporter > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd quadratic_residue && make quadratic_residue > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd random_numbers && make random_numbers > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd sieve_of_eratosthenes && make sieve_of_eratosthenes > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd subgroup_examplifier && make subgroup_examplifier > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd system_of_congruences && make system_of_congruences > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd View_LOGBOOK && make View_LOGBOOK > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd Wipe_ARCHIVE && make Wipe_ARCHIVE > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
...
cd Wipe_LOGBOOK && make Wipe_LOGBOOK > /dev/null 2>> ../../../._build_errors
if [ $? -eq 0 ];
