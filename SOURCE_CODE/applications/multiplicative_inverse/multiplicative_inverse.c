...
int main(int argc, char **argv) { mod = denominator = ADDITIVE_IDENTITY; mod_ = &mod; argv_ptr = &argv; 
    ...
    fprintf(stdout, "%lu^-%i \u2261 %i / %lu \u2261 ", denominator, NUMERATOR, NUMERATOR, denominator); mod_ = &mod;
