...
int main(int argc, char **argv) { argv_loc = &argv;
    unsigned long mod = 0; mod_ = &mod; conditional_goodbye(n(n(n(error_specification(mod_failed_to_parse, n(      ul_parse_str(mod_, argv[1], -1)))))));
    int id = 0; id_ = &id;              conditional_goodbye(n(n(n(error_specification(_id_failed_to_parse, n(identity_parse_str( &id, argv[2], -2)))))));
