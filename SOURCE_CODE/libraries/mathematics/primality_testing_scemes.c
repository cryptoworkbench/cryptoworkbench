...
_primality_test primality_test(int SELECTOR) {
    switch (SELECTOR) {
	case 7: return efficient_trial_division_PRIMALITY_TEST; case 6: return LESS_efficient_trial_division_PRIMALITY_TEST; case 5: return LEAST_efficient_trial_division_PRIMALITY_TEST;
	case 4: return efficient_trial_division_TABLE_AIDED_PRIMALITY_TEST; case 3: return LESS_efficient_trial_division_TABLE_AIDED_PRIMALITY_TEST;
	case 2: return LEAST_efficient_trial_division_TABLE_AIDED_PRIMALITY_TEST; case 1: return shor_factorization_PRIMALITY_TEST;
	case 0: return fermat_factorization_PRIMALITY_TEST; default: return NULL; };
