...
int _legendre_symbol(unsigned long odd_prime_p, unsigned long odd_prime_q) { MOD = odd_prime_q; if (exponentiation(odd_prime_p, (odd_prime_q - 1) / 2) + 1 == MOD) return -1; return 1; }
