...
cd subgroup_examplifier_SCRIPT && make subgroup_examplifier_SCRIPT > /dev/null 2>> ../../.script_initialization_errors
if [ $? -eq 0 ];
...
cd dh_key_agreement_SCRIPT && make dh_key_agreement_SCRIPT > /dev/null 2>> ../../.script_initialization_errors
if [ $? -eq 0 ];
...
cd prime_factorize_SCRIPT && make prime_factorize_SCRIPT > /dev/null 2>> ../../.script_initialization_errors
if [ $? -eq 0 ];
